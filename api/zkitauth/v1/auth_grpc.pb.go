...
const (
	AuthService_GenToken_FullMethodName    = "/zkitauth.v1.AuthService/GenToken"
	AuthService_VerifyToken_FullMethodName = "/zkitauth.v1.AuthService/VerifyToken"
)
...
func (c *authServiceClient) GenToken(ctx context.Context, in *GenTokenRequest, opts ...grpc.CallOption) (*GenTokenReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenTokenReply)
	err := c.cc.Invoke(ctx, AuthService_GenToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) VerifyToken(ctx context.Context, in *VerifyTokenRequest, opts ...grpc.CallOption) (*VerifyTokenReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAuthServiceServer) GenToken(context.Context, *GenTokenRequest) (*GenTokenReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GenToken not implemented")
}
func (UnimplementedAuthServiceServer) VerifyToken(context.Context, *VerifyTokenRequest) (*VerifyTokenReply, error) {
...
func _AuthService_GenToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_GenToken_FullMethodName,
	}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "zkitauth.v1.AuthService",
	...
	Metadata: "api/zkitauth/v1/auth.proto",
}
