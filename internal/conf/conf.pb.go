...
type Config struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Secretkey     *Config_Secretkey      `protobuf:"bytes,1,opt,name=secretkey,proto3" json:"secretkey,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Config_Secretkey struct {
	...
	Passwdkey     string                 `protobuf:"bytes,2,opt,name=passwdkey,proto3" json:"passwdkey,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Config_Secretkey) GetJwtkey() string {
	if x != nil {
		return x.Jwtkey
	}
	return ""
...
func (x *Config_Secretkey) GetPasswdkey() string {
	if x != nil {
		return x.Passwdkey
	}
	return ""
...
func (x *Registry_Consul) GetServername() string {
	if x != nil {
		return x.Servername
	}
	return ""
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\x06Config\x12:\n" +
	"\tsecretkey\x18\x01 \x01(\v2\x1c.kratos.api.Config.SecretkeyR\tsecretkey\x1aA\n" +
	"\tSecretkey\x12\x16\n" +
	"\x06jwtkey\x18\x01 \x01(\tR\x06jwtkey\x12\x1c\n" +
	"\tpasswdkey\x18\x02 \x01(\tR\tpasswdkey\"\x9b\x01\n" +
	"\bRegistry\x123\n" +
	"\x06consul\x18\x01 \x01(\v2\x1b.kratos.api.Registry.ConsulR\x06consul\x1aZ\n" +
	"\x06Consul\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12\x16\n" +
	"\x06scheme\x18\x02 \x01(\tR\x06scheme\x12\x1e\n" +
	"\n" +
	"servername\x18\x03 \x01(\tR\n" +
	"servernameB\x1fZ\x1dawStormOps/internal/conf;confb\x06proto3"
...
var file_internal_conf_conf_proto_goTypes = []any{
	...
	(*Config_Secretkey)(nil),    // 9: kratos.api.Config.Secretkey
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 3: kratos.api.Bootstrap.config:type_name -> kratos.api.Config
	...
	9,  // 8: kratos.api.Config.secretkey:type_name -> kratos.api.Config.Secretkey
